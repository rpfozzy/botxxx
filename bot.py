...
admin_id = 1653222949  # Ваш ID в Telegram для отправки ошибок
...
def handle_message(message):
    try:
        ...
        bot.send_message(admin_id, f"Произошла ошибка: {traceback.format_exc()}")
...
def get_gemini_response(question):
    try:
        ...
        bot.send_message(admin_id, f"Произошла ошибка в get_gemini_response: {traceback.format_exc()}")
        return "извините, произошла ошибка при обработке запроса"
...
def get_gemini_response_special(question, special_message):
    try:
        ...
        bot.send_message(admin_id, f"Произошла ошибка в get_gemini_response_special: {traceback.format_exc()}")
        return "извините, произошла ошибка при обработке запроса"
...
if __name__ == "__main__":
    try:
        ...
        bot.send_message(admin_id, f"Произошла ошибка в основном блоке: {traceback.format_exc()}")