...
# Словарь эмодзи и соответствующих стикеров
emoji_to_sticker = {
    '😈': ['CAACAgIAAxkBAAEDCJxi9_4JHCZb1QABulZgX_hPOI1F5wACZAADaG8eF4vI0bMXxxzULwQ', 'CAACAgIAAxkBAAEDCJ1i9_4QonR19Utx1XbE7D0tU9MZ4QACOwADaG8eFzmeX93jP3Q-LwQ'],
    '🤩': ['CAACAgIAAxkBAAEDCJ9i9_4T1yIC9Fsk5iQRpXLK8aYhrQACOAADaG8eF8wOIW7Z8E5ULwQ', 'CAACAgIAAxkBAAEDCKFi9_4YBumX58cty1r4T2hvMSfhkAACMAADaG8eF5YgrbRBQH-2LwQ'],
    '🥵': ['CAACAgIAAxkBAAEDCKNi9_4cwvtxDd3Q5qJ8i2mABU4--QACVQADaG8eF7otQ9cb1q1zLwQ', 'CAACAgIAAxkBAAEDCKVi9_4g0QMAARLAXodN_h0UuAeNnT4AAlcAA2hvHhfkgL5GdfyPtS8E'],
    '🤔': ['CAACAgIAAxkBAAEDCKdi9_4kBbtCTyV36hsbksMy5b5sTQACdgADaG8eF5_P-_azm2wBLwQ', 'CAACAgIAAxkBAAEDCKli9_4pD-XZqjXL_vF-kc5bsNBN2AACQgADaG8eFzAq-bZn9C7WLwQ'],
    '😭': ['CAACAgIAAxkBAAEDCKti9_4uUO0MZyG6aPRF9vB9U9a_tAACdgADaG8eF0vAczfiMWCwLwQ', 'CAACAgIAAxkBAAEDCK1i9_4y5TZgnOF-WqT4DO1DSrLq0AACjQADaG8eF8p7IYumzY9JLwQ']
}
...
def handle_message(message):
    try:
        ...
        if any(keyword in user_text for keyword in ["рп", "ресурс пак", "топ", "пвп", "текстур пак"]):
            ...
            # Отправка соответствующих стикеров
            for emoji, stickers in emoji_to_sticker.items():
                if emoji in gemini_response:
                    bot.send_sticker(message.chat.id, stickers[0])  # Отправка первого стикера из списка
                    break
