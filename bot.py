...
def handle_message(message):
    try:
        ...
        user_data[user_id].append(f"пользователь:\n{user_text}\n")
        ...
        if any(keyword in user_text for keyword in ["рп", "ресурс пак", "топ", "пвп", "текстур пак"]):
            ...
            user_data[user_id].append(f"ответ от меня:\n{response_text}\n")
